...
void DebugReadSetup(void){
	...
	sscanf(json_object_get_string(obj,"ip"),"%d.%d.%d.%d",&debugSetup.adr1,&debugSetup.adr2,&debugSetup.adr3,&debugSetup.adr4);
	IP_ADDR4(&debugSetup.ipAddr, debugSetup.adr1, debugSetup.adr2, debugSetup.adr3, debugSetup.adr4);
}
...
void DebugWriteSetup(void){
    ...
    sprintf(LoggerBuffer,"%d.%d.%d.%d",debugSetup.adr1, debugSetup.adr2, debugSetup.adr3, debugSetup.adr4);
